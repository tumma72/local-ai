...
class TestOutputConsole:
    ...
    @patch('local_ai.output.console.console.print')
    def test_print_warning(self, mock_print: pytest.Mock) -> None:
    ...
    @patch('local_ai.output.console.console.print')
    def test_print_info(self, mock_print: pytest.Mock) -> None:
